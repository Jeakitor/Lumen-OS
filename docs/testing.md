...
*Since I adlready had a bunch of programs pre-installed on arch and didnt want to install Debian tools I canceled the install*
*But don't worry the commands did run successfully :D*
